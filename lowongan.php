    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="lowongan.php">Lowongan</a></li>
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li><a href="informasi.php">Lowongan</a></li>
          <li>Lowongan</li>
        </ol>
        <h2 style="color: white">Lowongan Tersedia</h2>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-sm-7">
                            <p class="mb-0 f_400">© 2023-2024 BKK <a href="https://smknasionalindramayu.sch.id/" target="_blank">BKK SMKS NASIONAL INDRAMAYU</a>  All rights reserved.</p>
                        </div>
