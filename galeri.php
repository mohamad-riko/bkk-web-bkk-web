...
<!-- ======= Breadcrumbs ======= -->
    <section class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li><a href="informasi.php">Galeri</a></li>
          <li>Galeri</li>
        </ol>
  ...
  <!--  <section id="portfolio" class="portfolio">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data-filter=".filter-app">Galeri</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="admin/img/logo.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>JUDUL </h4>
                <p>JUDUL</p>
                <div class="portfolio-links">
                  <a href="admin/img/logo.png" data-gallery="portfolioGallery" class="portfokio-lightbox" title="JUDUL"><i class="bi bi-plus"></i></a>
                </div>
              </div>
            </div>
          </div>
   ...
   <section id="portfolio" class="portfolio">
      ...
      <center>
         <img src="admin/img/giphy3.gif"> \
         <br>
        <span style="font-style: italic;"> -- Sedang Dalam Pengembangan -- </span>
      </center>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="f_widget company_widget wow fadeInLeft" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInLeft;">
                                ...
                                <img src="admin/img/logo.png" style="height: 100px">
